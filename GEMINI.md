...
Workspace customizations and skills for Gemini / Antigravity are configured under `.agents/skills/oai-*/SKILL.md`. **Before editing OAI code, verify that the relevant skills are active:**

#### Activation matrix

| Skill | Skill file | Read when touching |
|-------|------------|-------------------|
| **oai-devops** | `.agents/skills/oai-devops/SKILL.md` | `oai/helm-chart/**`, `oai/Dockerfile`, `oai/docker-compose*.yml`, `oai/Taskfile.yml` (deploy/docker/infra tasks) |
| **oai-itests** | `.agents/skills/oai-itests/SKILL.md` | `oai/itests/**` |
| **oai-chat** | `.agents/skills/oai-chat/SKILL.md` | Chat feature files (patterns below) |
| **oai-img** (Priority) | `.agents/skills/oai-img/SKILL.md` | Image feature files (patterns below) |
| **oai-backend** | `.agents/skills/oai-backend/SKILL.md` | Any `oai/backend/**` file, or cross-cutting backend work |
| **oai-frontend** | `.agents/skills/oai-frontend/SKILL.md` | Any `oai/frontend/**` file, or cross-cutting SPA work |
...
#### oai-img (Priority) — file patterns
