...
pub struct NewJobInput<'a> {
    ...
    pub txt2video_capability: &'a str,
    pub img2video_capability: Option<&'a str>,
...
pub async fn create_job(
    ...
    let model = movie_jobs::ActiveModel {
        ...
        txt2video_capability: ActiveValue::Set(input.txt2video_capability.to_string()),
        img2video_capability: ActiveValue::Set(input.img2video_capability.map(str::to_string)),
