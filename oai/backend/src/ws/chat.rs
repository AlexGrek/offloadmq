...
async fn handle_text(
    ...
    match cmd {
        ...
        ClientCommand::Chat { req_id, capability, chat_id, content, timeout_secs, max_wait_secs, runtime_secs } => {
            chat::chat(req_id, capability, chat_id, content, timeout_secs, max_wait_secs, runtime_secs, tx, state, user_id).await;
        }
    }
}
