...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-dvh overflow-hidden bg-background" data-testid="chat-page">
      {/* ── Sidebar ── */}
      <aside
        className={cn(
            ...
            chats.map(chat => (
              ...
              >
                ...
                <button
                  ...
                  title="Delete chat"
                  className="shrink-0 mr-1 p-1 rounded opacity-0 group-hover/chat-item:opacity-100 hover:bg-destructive/10 hover:text-destructive transition-all"
                >
